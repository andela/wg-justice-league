...
latex_documents = [('index', 'wgerWorkoutManager.tex', u'wger Workout Manager Documentation',
...
texinfo_documents = [('index', 'wgerWorkoutManager', u'wger Workout Manager Documentation',
